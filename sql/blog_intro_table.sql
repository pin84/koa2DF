...
--
-- Table structure for table `intro_table`
--
...
--
-- Dumping data for table `intro_table`
--

LOCK TABLES `intro_table` WRITE;
/*!40000 ALTER TABLE `intro_table` DISABLE KEYS */;
/*!40000 ALTER TABLE `intro_table` ENABLE KEYS */;
UNLOCK TABLES;
